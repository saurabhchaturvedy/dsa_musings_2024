...
public class ListUnion {
    ...
    private static ListNode mergeWithUnion(ListNode left, ListNode right) {
    ...
    public static ListNode union(ListNode first, ListNode second) {
        ...
        return mergeWithUnion(left, right);
    }
    ...
    public static void main(String[] args) {
        ...
        ListNode union = union(root, root2);


        LinkedListUtils.print(union);
