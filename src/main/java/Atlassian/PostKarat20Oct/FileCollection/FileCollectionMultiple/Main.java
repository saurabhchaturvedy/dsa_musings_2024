...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        fileStorageSystem.addFile(new FileMetadata("file2.txt", 200, Arrays.asList("collection1")));
        fileStorageSystem.addFile(new FileMetadata("file3.txt", 200, Arrays.asList("collection1")));
        fileStorageSystem.addFile(new FileMetadata("file4.txt", 300, Arrays.asList("collection1", "collection2")));
